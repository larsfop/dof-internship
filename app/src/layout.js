...
export class Layout {
    ...
    createUI() {
        ...
        this.expandButton.onclick = () => {
            ...
            this.layoutContainer.classList.toggle('expanded');
    ...
    createPanelUI(fill = true) {
        ...
        if (fill) {
            ...
            panelContainer.appendChild(this.tabContainer); // Append the tab container to the panel container
    ...
    addTab(tabIdx, type = 'chatbox', sessionID = null, data = null) {
        // Fill window content
        const tab = new Tabs(this.panelIdx, tabIdx, this);
        tab.setupContent(type, data);
        tab.setupChatSender(this.history);
