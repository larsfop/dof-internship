...
$baseUrl = "http://localhost:8015/process_all_pdfs?is_partitioning=$IsPartitioning&is_chunking=$IsChunking&is_vector_storing=$IsStoring&load_checkpoint=$LoadCheckpoint&recreate=$Recreate"
